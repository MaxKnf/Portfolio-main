...
const rows = [
  createData(
    "Horizon Studio",
    "Site vitrine d'une agence de design d'intérieur",
    "Javascript, React.js, MaterialUI",
    {
      github: "https://github.com/MaxKnf/Horizon-Studio",
      website: "https://horizon-studio.netlify.app/",
    },
    <GitHubIcon />,
    <LanguageIcon />
  ),
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >
        ...
        <a href="https://github.com/MaxKnf?tab=repositories" target="_blank">
          <GitHubIcon
        ...
        >
          <Table
            sx={{ width: "100%", backgroundColor: "#212121" }}
            ...
            <TableBody>
              {rows.map((row) => (
                ...
                >
                  ...
                  <TableCell sx={{ color: "white" }}>
                    <a href={row.link.github} target="_blank">
                      {row.githubIcon}
                    </a>{" "}
                    <a href={row.link.website} target="_blank">
                      {row.websiteIcon}
                    </a>
                  </TableCell>
                </TableRow>
